...
?>
<?
$arPhoto = CFile::ResizeImageGet($arResult["DETAIL_PICTURE"]["ID"], array('width'=>760, 'height'=>506), BX_RESIZE_IMAGE_EXACT, true);
?>
<div itemscope itemtype="http://schema.org/Product" class="product">
  <div class="product-photo-holder"><img src="<?=$arPhoto['src']?>" alt="<?=$arResult['NAME']?>" itemprop="image" width="760" height="506" class="product-photo"></div>
  <div class="product-info">
	...
	<div class="product-info-item product-info-item--right product-actions">		
		<!--noindex-->
	  ...
	  <div class="product-action-item-holder"><a href="<?=$arResult['DETAIL_PAGE_URL']?>?small=1" title="Закрыть" class="product-action-item product-action-item--close custom-btn custom-btn--white custom-btn--large custom-btn--uppercase custom-btn--nowrap"><span class="custom-btn-name">Закрыть</span></a></div>
	</div>
  </div>
</div>
<?
