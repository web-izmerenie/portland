...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="board-item-inner">
		<div style="background-image: url(<?=$arPhoto['src']?>)" class="board-item-photo-holder"><img itemprop="image" src="<?=$arPhoto['src']?>" alt="<?=$arItem["NAME"]?>" width="750" height="453" class="board-item-photo"><!--noindex--><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="" width="100%" class="board-item-photo-spacer"><!--/noindex--></div>
