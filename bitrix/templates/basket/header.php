...
<html lang="ru" prefix="og: http://ogp.me/ns#" class="no-js"><!--<![endif]-->
    ...
    <body itemscope itemtype="http://schema.org/WebPage" class="calculator-page">
				...
				<div class="page-main">
				  <div class="page-inner">
					<div class="page-main-holder">
						<div class="calculator-page-heading justify-alignment">
							<div class="justify-item justify-item--middle">
							  <h1 class="calculator-page-heading-name"><?$APPLICATION->ShowTitle(false)?></h1>
							</div>
							<div class="justify-item justify-item--middle calculator-page-heading-back"><a href="/catalog/" class="custom-back-block-link custom-back-block-link--brown custom-back-block-link--large custom-back-block-link--uppercase"><span class="custom-back-block-link-name">Вернуться к выбору блюд</span></a></div>
						  </div>
					  <div class="page-main-content" id="basket_container">											  