    ...
    <body itemscope itemtype="http://schema.org/WebPage" class="reviews-page">
        ...
        <div style="background-image: url()" class="page">
            ...
            <main itemscope itemprop="mainContentOfPage" class="page-content">
                <div style="background-image: url(/dummy/menu/header.jpg)" class="page-heading page-heading--background">
					...
					<!--noindex-->
					<div id="basket_container" class="justify-item page-heading-basket-holder">
					<?$APPLICATION->IncludeComponent(
