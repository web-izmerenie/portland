...
?>
					  ...
					  <aside class="page-main-aside">
						<div class="popup-panel popup-panel--white">
						  <div class="popup-panel-top panel-white-top-icon-inner panel-white-lt-icon-before panel-white-rt-icon-after"></div>
						  <div class="page-text popup-panel-content panel-white-left-icon-before panel-white-right-icon-after">
							<div class="page-text-small page-text--center">
