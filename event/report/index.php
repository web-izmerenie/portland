...
if(!$_REQUEST["empty"]){	
	...
	?>
	<?$APPLICATION->IncludeComponent("bitrix:news", "reports_v2", Array(
	"IBLOCK_TYPE" => "about",	// Тип инфоблока
		"IBLOCK_ID" => "8",	// Инфоблок
		"NEWS_COUNT" => $nPage,	// Количество новостей на странице
		...
		"SEF_FOLDER" => "/event/report/",	// Каталог ЧПУ (относительно корня сайта)
...
4 => "VIDEO_LIST",
		...
		"PAGER_TEMPLATE" => "board",	// Шаблон постраничной навигации
