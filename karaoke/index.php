...
if(!$_REQUEST["empty"]){	
	...
	$dbEventFirst = CIBlockElement::GetList(array('ACTIVE_FROM'=>'DESC', 'NAME'=>'ASC'), array('IBLOCK_ID'=>15, 'ACTIVE'=>'Y', "CHECK_PERMISSIONS" => "Y"), false, array('nTopCount'=>$nPage), array('ID'));
...
?> <? if($APPLICATION->GetCurPageParam() == '/karaoke/'){ ?>
